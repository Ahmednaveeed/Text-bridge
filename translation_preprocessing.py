...
def preprocess_translation_data():
    ...
    en_padded, en_tokenizer = tokenize(en, 'English')
    ur_padded, ur_tokenizer = tokenize(ur, 'Urdu')
    ...
    x_train, x_val, y_train, y_val = train_test_split(en_padded, ur_padded, test_size=0.2, random_state=42)

    return (x_train, y_train), (x_val, y_val), en_tokenizer, ur_tokenizer
